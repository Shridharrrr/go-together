...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 overflow-x-hidden">
      ...
      {/* Hero Section */}
      <div className="flex flex-col lg:flex-row justify-center items-center px-6 md:px-12 mb-16 md:mb-32 text-center lg:text-left">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center p-6 sm:p-8 md:p-12 lg:p-16 gap-8 sm:gap-12 md:gap-24 bg-slate-900 w-full">
        <div className="text-center md:text-left max-w-md flex flex-col items-center">
          <h3 className="text-2xl sm:text-3xl md:text-4xl text-indigo-500 font-semibold">What's your destination?</h3>
          <p className="text-gray-200 font-light mt-2 text-sm sm:text-base">Let's make this your least expensive journey ever</p>
          <button
            onClick={() => router.push("/create-ride")}
            className="relative group text-base sm:text-lg md:text-xl bg-indigo-500 w-full sm:w-[200px] md:w-[250px] font-semibold text-white p-3 md:p-4 mt-6 rounded-full hover:bg-indigo-600 active:bg-indigo-700 transition-all overflow-hidden"
          >
      ...
      {/* Footer Section */}
      <footer className="flex flex-col md:flex-row justify-between items-center bg-gray-800 py-6 px-4 sm:px-6 md:px-12 text-center md:text-left">
        <div className="mb-4 md:mb-0">
          <h1 className="text-xl sm:text-2xl font-bold text-indigo-400">
            <span className="text-white">Go</span>Together
          </h1>
          <p className="text-gray-400 text-sm sm:text-md">The best way to share rides and travel affordably.</p>
        </div>
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 md:gap-6 items-center">
          <h1 className="text-base sm:text-lg md:text-xl font-semibold text-white">Connect with me</h1>
